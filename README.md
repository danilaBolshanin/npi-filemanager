...
```bash
pip install npi_file_manager_ext
```
...
```bash
pip uninstall npi_file_manager_ext
```
...
# Change directory to the npi_file_manager_ext directory
...
folder is located. Then you can remove the symlink named `npi-file-manager-ext` within that folder.
